...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_TIMEx_HallSensor_Init_B(TIM_HandleTypeDef *htim, TIM_HallSensor_InitTypeDef *sConfig)
{
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_TIMEx_OCN_Start_DMA_B(TIM_HandleTypeDef *htim, uint32_t Channel, uint32_t *pData, uint16_t Length)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint32_t tmpsmcr;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_TIMEx_PWMN_Start_DMA_B(TIM_HandleTypeDef *htim, uint32_t Channel, uint32_t *pData, uint16_t Length)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint32_t tmpsmcr;
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_TIMEx_MasterConfigSynchronization_B(TIM_HandleTypeDef *htim,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_TIMEx_ConfigBreakDeadTime_B(TIM_HandleTypeDef *htim,
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_TIMEx_ConfigBreakInput_B(TIM_HandleTypeDef *htim,
                                             uint32_t BreakInput,
...
/**
  ...
  * @retval HAL state
  */
HAL_TIM_StateTypeDef HAL_TIMEx_HallSensor_GetState_B(TIM_HandleTypeDef *htim)
{
  return htim->State;
}
...
/**
  ...
  */
HAL_TIM_ChannelStateTypeDef HAL_TIMEx_GetChannelNState_B(TIM_HandleTypeDef *htim,  uint32_t ChannelN)
{
