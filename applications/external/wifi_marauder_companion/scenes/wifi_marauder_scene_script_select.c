...
static void
    wifi_marauder_scene_script_select_script_list_enter_callback(void* context, uint32_t index) {
    furi_assert(context);
...
void wifi_marauder_scene_script_select_on_enter(void* context) {
    ...
    variable_item_list_set_enter_callback(
        script_var_item_list, wifi_marauder_scene_script_select_script_list_enter_callback, app);
    ...
    variable_item_list_set_selected_item(
        script_var_item_list,
        scene_manager_get_scene_state(app->scene_manager, WifiMarauderSceneScriptSelect));
