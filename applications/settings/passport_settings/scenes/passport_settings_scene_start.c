...
const char* const background_text[PASSPORT_BG_COUNT] =
    {"None", "DB", "Flipper", "Furipass", "Mario", "Mountains", "Multipass", "Scroll", "Slutpass"};

const uint32_t background_value[PASSPORT_BG_COUNT] =
    {BG_NONE, BG_DB, BG_STOCK, BG_FURI, BG_MARIO, BG_MOUNTAINS, BG_MULTI, BG_SCROLL, BG_SLUT};

const char* const image_text[PROFILE_IMG_COUNT] = {
    "None",        "Briareos",   "Cobra",      "Dali Mask",  "Dolphin Pet",  "Dolphin (Moody)",
    "ED-209",      "FSociety",   "Goku (Set)", "Goku (Kid)", "Goku (Adult)", "Goku (SSJ)",
    "Goku (SSJ3)", "Guy Fawkes", "Lain",       "Mario",      "Marvin",       "Moreleeloo",
    "Neuromancer", "Rabbit",     "Shinkai",    "Slime",      "Sonic",        "Spider Jerusalem",
    "Tank Girl",   "Totoro",     "Waifu 1",    "Waifu 2",    "Waifu 3"};

const uint32_t image_value[PROFILE_IMG_COUNT] = {
    PIMG_NONE,         PIMG_BRIAREOS, PIMG_COBRA,       PIMG_DALI,        PIMG_DOLPHIN,
    PIMG_DOLPHINMOODY, PIMG_ED209,    PIMG_FSOCIETY,    PIMG_GOKUSET,     PIMG_GOKUKID,
    PIMG_GOKUADULT,    PIMG_GOKUSSJ,  PIMG_GOKUSSJ3,    PIMG_GUYFAWKES,   PIMG_LAIN,
    PIMG_MARIO,        PIMG_MARVIN,   PIMG_MORELEELLOO, PIMG_NEUROMANCER, PIMG_RABBIT,
    PIMG_SHINKAI,      PIMG_SLIME,    PIMG_SONIC,       PIMG_SPIDER,      PIMG_TANKGIRL,
